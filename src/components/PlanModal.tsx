...
import { X, CheckCircle, Loader2, User, Mail, Phone, Building } from "lucide-react";
...
export const PlanModal = ({ isOpen, onClose, planName, planPrice }: PlanModalProps) => {
              ...
              <div className="flex items-center justify-between p-6 border-b border-border bg-gradient-to-r from-primary/10 to-transparent">
                <div>
                  <h3 className="text-xl font-display font-bold text-foreground">
                    {isSuccess ? "Pedido Enviado!" : planName}
                  </h3>
                  {!isSuccess && (
                    <p className="text-sm text-muted-foreground mt-1">
                      {planPrice ? `${planPrice} Kz` : "Preço personalizado"}
                    </p>
                  )}
                </div>
                <button
                  ...
                  {isSuccess ? (
                    ...
                    >
                      ...
                      <p className="text-muted-foreground mb-6">
                        Recebemos o seu pedido para o <strong>{planName}</strong>. 
                    ...
                    >
                      <p className="text-sm text-muted-foreground mb-4">
                        Preencha os seus dados para aderir a este plano
                      </p>
